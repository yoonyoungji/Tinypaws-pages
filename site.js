...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.6.6", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.6.6 업데이트", releaseLead: "마카오와 조마의 걷기 프레임을 보강해 움직임이 더 부드럽게 이어져요.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.6.6", releaseLead: "Macau & Joma now have extra walking frames for smoother movement.",
...
releaseVersions.unshift("1.6.6", "1.6.5", "1.6.4", "1.6.3", "1.6.2", "1.6.1", "1.6.0", "1.5.9", "1.5.8", "1.5.7", "1.5.6", "1.5.5");
