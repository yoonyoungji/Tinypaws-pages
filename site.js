...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.5.5", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.5.5 업데이트", releaseLead: "메뉴 막대에서 TinyPaws를 바로 재시작할 수 있어요.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.5.5", releaseLead: "Restart TinyPaws directly from the menu bar.",
