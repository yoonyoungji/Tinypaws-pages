...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.2.6", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.2.6 업데이트", releaseLead: "익명 사용 통계를 TelemetryDeck 기반으로 정리하고 개인정보처리방침을 최신 내용으로 업데이트했습니다.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.2.6", releaseLead: "Moved anonymous usage statistics to TelemetryDeck and refreshed the privacy policy details.",
...
copy.ko.privacy = {
  ...
  analyticsLead: "TinyPaws는 앱 실행, 설치 또는 업데이트, 설정 변경과 도움말·업데이트 확인 같은 기능 사용을 익명으로 집계할 수 있습니다. 이 통계에는 앱 버전·빌드 번호, macOS 버전, 기기 모델·화면 해상도·언어·지역·시간대 같은 기술 정보가 포함될 수 있지만, 이름, 이메일, 입력한 내용, 결제 정보 또는 계정 기반 식별 정보는 전송하지 않습니다.",
  thirdLead: "익명 사용 통계에는 TelemetryDeck을 사용할 수 있습니다. 이 서비스는 개인을 식별하지 않는 방식으로 앱 사용 추세를 집계하며, TinyPaws의 핵심 데스크톱 컴패니언 기능에 필요하지 않습니다."
};
...
copy.en.privacy = {
  ...
  analyticsLead: "TinyPaws may anonymously measure app launches, installs or updates, setting changes, and use of features such as help and update checks. These statistics may include technical information such as the app version and build number, macOS version, device model, screen resolution, language, region, and time zone, but never your name, email address, typed content, payment information, or account-based identifying information.",
  thirdLead: "TinyPaws may use TelemetryDeck for anonymous usage statistics. The service aggregates app trends without directly identifying people and is not required for the core desktop-companion experience."
};
...
const releaseVersions = ["1.2.6", "1.2.5", "1.2.4", "1.2.3", "1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
