...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.5.8", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.5.8 업데이트", releaseLead: "캐릭터 선택 메뉴 정렬을 다듬고, 화면 가장자리에서도 점프가 자연스럽게 보이도록 개선했어요.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.5.8", releaseLead: "Character sub-pickers are better centered, and jumps now stay natural along every screen edge.",
...
releaseVersions.unshift("1.5.8", "1.5.7", "1.5.6", "1.5.5");
