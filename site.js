...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.5.9", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      companions: "여덟 명의 데스크톱 친구", companionsLead: "카피바라, 아메리칸 숏헤어, 러시안 블루, 고슴도치, 꺼먹살이, 푸들, 햄스터, 스페셜 캐릭터 버거 중 마음에 드는 친구를 고를 수 있어요.",
      ...
      release: "1.5.9 업데이트", releaseLead: "빨간 망토의 스페셜 캐릭터 버거가 찾아왔어요. 보안 입력 후에도 키보드 반응이 자연스럽게 이어지도록 개선했어요.",
  ...
  en: {
    ...
    index: {
      ...
      companions: "Eight desktop companions", companionsLead: "Choose the friend that feels right: Capybara, American Shorthair, Russian Blue, Hedgehog, Kkeomeoksari, Poodle, Hamster, or the special character Burger.",
      ...
      release: "New in 1.5.9", releaseLead: "Meet Burger, a special red-caped companion. Keyboard reactions now resume naturally after secure text input.",
...
copy.ko.privacy = {
  ...
  localItems: ["선택한 캐릭터", "선택한 사이즈", "선택한 투명도", "선택한 걷기 속도", "선택한 이동 범위와 걷기 스타일"],
...
copy.en.privacy = {
  ...
  localItems: ["Selected character", "Selected size", "Selected opacity", "Selected walk speed", "Selected movement range and walking style"],
...
releaseVersions.unshift("1.5.9", "1.5.8", "1.5.7", "1.5.6", "1.5.5");
