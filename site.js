...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.4.1", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      companions: "여섯 명의 데스크톱 친구", companionsLead: "카피바라, 고양이, 고슴도치, 꺼먹살이, 푸들, 햄스터 중 마음에 드는 캐릭터를 고를 수 있어요.",
      ...
      release: "1.4.1 업데이트", releaseLead: "아이템 착용 상태 표시와 사이트 후기 섹션을 다듬었습니다.",
  ...
  en: {
    ...
    index: {
      ...
      companions: "Six desktop companions", companionsLead: "Choose the friend that feels right: Capybara, Cat, Hedgehog, Kkeomeoksari, Poodle, or Hamster.",
      ...
      release: "New in 1.4.1", releaseLead: "Improved item-equipped feedback and added a reactions section.",
...
const characters = [["kkeomeoksari", "Kkeomeoksari", "꺼먹살이"], ["capybara", "Capybara", "카피바라"], ["cat", "Cat", "고양이"], ["hedgehog", "Hedgehog", "고슴도치", true], ["poodle", "Poodle", "푸들"], ["hamster", "Hamster", "햄스터"]];
const releaseVersions = ["1.4.1", "1.4.0", "1.3.9", "1.3.8", "1.3.7", "1.3.6", "1.3.5", "1.3.4", "1.3.3", "1.3.2", "1.3.1", "1.3.0", "1.2.9", "1.2.8", "1.2.7", "1.2.6", "1.2.5", "1.2.4", "1.2.3", "1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
