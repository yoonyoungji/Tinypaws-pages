...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.2.8", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.2.8 업데이트", releaseLead: "마우스 클릭으로 캐릭터가 바라보는 방향을 바꾸고, 화면 가장자리 걷기 방향 전환을 더 자연스럽게 다듬었습니다.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.2.8", releaseLead: "Added click-to-turn movement controls and refined edge-walking direction changes.",
...
const releaseVersions = ["1.2.8", "1.2.7", "1.2.6", "1.2.5", "1.2.4", "1.2.3", "1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
