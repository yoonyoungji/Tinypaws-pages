...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.2.2", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      gallery: "앱 미리보기", galleryLead: "TinyPaws를 어떻게 꾸미고 함께할 수 있는지 화면으로 살펴보세요.", galleryItems: [["main", "작업 화면의 작은 친구", "화면 위에서 자연스럽게 움직이며 일상에 작은 생기를 더합니다."], ["characters", "마음에 드는 캐릭터", "여섯 명의 친구 중 함께할 캐릭터를 골라 보세요."], ["customize", "내 취향대로 조절", "크기, 투명도, 걷기 속도를 작업 환경에 맞게 조절할 수 있어요."], ["animation", "움직임이 살아 있는 화면", "입력과 설정에 반응하는 자연스러운 애니메이션을 만나 보세요."]],
  ...
  en: {
    ...
    index: {
      ...
      gallery: "A closer look", galleryLead: "See how TinyPaws fits into your desktop and makes the experience your own.", galleryItems: [["main", "A small friend at work", "TinyPaws moves naturally across your screen and adds a little life to everyday work."], ["characters", "Choose your companion", "Pick the friend you want beside you from six animated characters."], ["customize", "Make it yours", "Tune size, opacity, and walk speed for the way you work."], ["animation", "Movement with personality", "Enjoy natural animation that responds to your input and settings."]],
...
const releaseVersions = ["1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
