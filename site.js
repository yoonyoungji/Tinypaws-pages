...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.3.2", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.3.2 업데이트", releaseLead: "메뉴에서 오늘의 TinyPaws와 친밀도 상태를 확인할 수 있게 추가했습니다.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.3.2", releaseLead: "Added a Today in TinyPaws menu with friendship status and daily messages.",
...
const characters = [["kkeomeoksari", "Kkeomeoksari", "꺼먹살이", true], ["capybara", "Capybara", "카피바라"], ["cat", "Cat", "고양이"], ["gorilla", "Gorilla", "고릴라"], ["poodle", "Poodle", "푸들"], ["hamster", "Hamster", "햄스터"]];
const releaseVersions = ["1.3.2", "1.3.1", "1.3.0", "1.2.9", "1.2.8", "1.2.7", "1.2.6", "1.2.5", "1.2.4", "1.2.3", "1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
