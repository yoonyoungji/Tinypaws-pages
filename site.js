...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.4.2", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      companions: "일곱 명의 데스크톱 친구", companionsLead: "카피바라, 고양이, 러시안 블루, 고슴도치, 꺼먹살이, 푸들, 햄스터 중 마음에 드는 캐릭터를 고를 수 있어요.",
      ...
      release: "1.4.2 업데이트", releaseLead: "러시안 블루를 추가하고 캐릭터 선택 화면과 액세서리 표현을 다듬었습니다.",
  ...
  en: {
    ...
    index: {
      ...
      companions: "Seven desktop companions", companionsLead: "Choose the friend that feels right: Capybara, Cat, Russian Blue, Hedgehog, Kkeomeoksari, Poodle, or Hamster.",
      ...
      release: "New in 1.4.2", releaseLead: "Added Russian Blue and refined the character picker and accessory details.",
...
const characters = [["kkeomeoksari", "Kkeomeoksari", "꺼먹살이"], ["capybara", "Capybara", "카피바라"], ["cat", "Cat", "고양이"], ["russian-blue", "Russian Blue", "러시안 블루", true], ["hedgehog", "Hedgehog", "고슴도치"], ["poodle", "Poodle", "푸들"], ["hamster", "Hamster", "햄스터"]];
const releaseVersions = ["1.4.2", "1.4.1", "1.4.0", "1.3.9", "1.3.8", "1.3.7", "1.3.6", "1.3.5", "1.3.4", "1.3.3", "1.3.2", "1.3.1", "1.3.0", "1.2.9", "1.2.8", "1.2.7", "1.2.6", "1.2.5", "1.2.4", "1.2.3", "1.2.2", "1.2.1", "1.2.0", "1.1.9", "1.1.8", "1.1.7", "1.1.6", "1.1.5", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0"];
...
function indexPage(c) {
  ...
  const characterCards = characters.map(([asset, en, ko, isNew]) => `<div class="character${isNew ? " featured" : ""}">${isNew ? '<span class="character-badge">NEW</span>' : ""}<img class="character-icon" src="./character-assets/${asset}.png" alt="" loading="lazy"><strong>${esc(c === copy.ko ? ko : en)}</strong><small>${esc(c === copy.ko ? en : ko)}</small></div>`).join("");
