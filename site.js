...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.4.9", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.4.9 업데이트", releaseLead: "캐릭터 크기에 맞춰 이동 속도를 보정하고, 새 설치의 기본 친구를 변경했습니다.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.4.9", releaseLead: "Adjusted movement speed for each character size and changed the default friend for new installs.",
