...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.6.3", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.6.3 업데이트", releaseLead: "선택한 캐릭터를 1·3·5마리로 늘릴 수 있어요. 테두리 모드에서는 한 줄로 함께 걸어요.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.6.3", releaseLead: "Choose one, three, or five copies of your character. In edge-walking mode, they follow in a line.",
...
releaseVersions.unshift("1.6.3", "1.6.2", "1.6.1", "1.6.0", "1.5.9", "1.5.8", "1.5.7", "1.5.6", "1.5.5");
