...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.5.0", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.5.0 업데이트", releaseLead: "키보드 입력 전달을 가볍게 만들고 애니메이션 갱신 부하를 줄였습니다.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.5.0", releaseLead: "Reduced keyboard-input overhead and made animation updates more efficient.",
