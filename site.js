...
const copy = {
  ko: {
    common: { home: "홈", support: "지원", privacy: "개인정보처리방침", releases: "버전 기록", download: "TinyPaws 다운로드", latest: "최신 버전 1.6.7", email: "문의 이메일", developer: "개발자: youngji Yoon", response: "답변은 보통 3영업일 안에 드립니다.", footer: "TinyPaws 공식 지원 및 개인정보처리방침", close: "닫기" },
    index: {
      ...
      release: "1.6.7 업데이트", releaseLead: "새로 설치하면 카피바라와 함께 시작해요.",
  ...
  en: {
    ...
    index: {
      ...
      release: "New in 1.6.7", releaseLead: "New installations now start with Capybara selected.",
...
releaseVersions.unshift("1.6.7", "1.6.6", "1.6.5", "1.6.4", "1.6.3", "1.6.2", "1.6.1", "1.6.0", "1.5.9", "1.5.8", "1.5.7", "1.5.6", "1.5.5");
